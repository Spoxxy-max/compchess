    ...
    <div className="w-full">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold flex items-center gap-2">
          ...
          Tournaments
          <Badge variant="outline" className="ml-2 bg-secondary text-xs">
            Coming Soon
          </Badge>
        </h2>
        <Button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="bg-card/60 border border-white/5 backdrop-blur-sm relative overflow-hidden group">
          ...
          <CardContent className="pb-2">
            ...
            <div className="text-sm mt-2">
              <span className="text-solana font-semibold">2.5 SOL</span> prize
              pool
            </div>
          </CardContent>
          <CardFooter>
        ...
        <Card className="bg-card/60 border border-white/5 backdrop-blur-sm relative overflow-hidden group">
          ...
          <CardContent className="pb-2">
            ...
            <div className="text-sm mt-2">
              <span className="text-solana font-semibold">10 SOL</span> prize
              pool
            </div>
          </CardContent>
          <CardFooter>
